...
<div class="profile edit-data col-md-12 col-lg-12 col-sm-12 col-xs-12 no-padding">
    ...
    <div class="edit-data-content" style="width: calc(100% - 350px)">
        ...
        <?= ($person->getPrimaryPosition()) ? \moco\ui\Formatting::diffDatesStringFormatYmd(new DateTime("now"), $person->getPrimaryPosition()->getEntryDate()) . ' ' .\moco\ui\Formatting::showDatesRange($person->getPrimaryPosition()->getEntryDate(), $person->getPrimaryPosition()->getExitDate()) : '-' ?>
        </div>
        <?php if (!is_null($person->getSalaryincrement())): ?>
