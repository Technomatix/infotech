...
$string['leary'] = 'Leary test';
$string['leary_help'] = 'The student receives points on the graduation test "Leary".';
...
$string['scoringmethod_help'] = '<strong> Individual typological questionnaire (ITO): </strong> After carefully reading each statement, put the CHECK in the YES column if you agree with the content, if not then put the CHECK in the NO column. ' .
